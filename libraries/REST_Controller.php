...
abstract class REST_Controller extends \CI_Controller {
    ...
    /*Testes forçados para o Android (Volley)
    const HTTP_CONTINUE                                                     = 200;
    const HTTP_SWITCHING_PROTOCOLS                                          = 200;
    const HTTP_PROCESSING                                                   = 200;
    const HTTP_OK                                                           = 200;
    const HTTP_CREATED                                                      = 200;
    const HTTP_ACCEPTED                                                     = 200;
    const HTTP_NON_AUTHORITATIVE_INFORMATION                                = 200;
    const HTTP_NO_CONTENT                                                   = 200;
    const HTTP_RESET_CONTENT                                                = 200;
    const HTTP_PARTIAL_CONTENT                                              = 200;
    const HTTP_MULTI_STATUS                                                 = 200;
    const HTTP_ALREADY_REPORTED                                             = 200;
    const HTTP_IM_USED                                                      = 200;
    const HTTP_MULTIPLE_CHOICES                                             = 200;
    const HTTP_MOVED_PERMANENTLY                                            = 200;
    const HTTP_FOUND                                                        = 200;
    const HTTP_SEE_OTHER                                                    = 200;
    const HTTP_NOT_MODIFIED                                                 = 200;
    const HTTP_USE_PROXY                                                    = 200;
    const HTTP_RESERVED                                                     = 200;
    const HTTP_TEMPORARY_REDIRECT                                           = 200;
    const HTTP_PERMANENTLY_REDIRECT                                         = 200;
    const HTTP_BAD_REQUEST                                                  = 200;
    const HTTP_UNAUTHORIZED                                                 = 200;
    const HTTP_PAYMENT_REQUIRED                                             = 200;
    const HTTP_FORBIDDEN                                                    = 200;
    const HTTP_NOT_FOUND                                                    = 200;
    const HTTP_METHOD_NOT_ALLOWED                                           = 200;
    const HTTP_NOT_ACCEPTABLE                                               = 200;
    const HTTP_PROXY_AUTHENTICATION_REQUIRED                                = 200;
    const HTTP_REQUEST_TIMEOUT                                              = 200;
    const HTTP_CONFLICT                                                     = 200;
    const HTTP_GONE                                                         = 200;
    const HTTP_LENGTH_REQUIRED                                              = 200;
    const HTTP_PRECONDITION_FAILED                                          = 200;
    const HTTP_REQUEST_ENTITY_TOO_LARGE                                     = 200;
    const HTTP_REQUEST_URI_TOO_LONG                                         = 200;
    const HTTP_UNSUPPORTED_MEDIA_TYPE                                       = 200;
    const HTTP_REQUESTED_RANGE_NOT_SATISFIABLE                              = 200;
    const HTTP_EXPECTATION_FAILED                                           = 200;
    const HTTP_I_AM_A_TEAPOT                                                = 200;
    const HTTP_UNPROCESSABLE_ENTITY                                         = 200;
    const HTTP_LOCKED                                                       = 200;
    const HTTP_FAILED_DEPENDENCY                                            = 200;
    const HTTP_RESERVED_FOR_WEBDAV_ADVANCED_COLLECTIONS_EXPIRED_PROPOSAL    = 200;
    const HTTP_UPGRADE_REQUIRED                                             = 200;
    const HTTP_PRECONDITION_REQUIRED                                        = 200;
    const HTTP_TOO_MANY_REQUESTS                                            = 200;
    const HTTP_REQUEST_HEADER_FIELDS_TOO_LARGE                              = 200;
    const HTTP_INTERNAL_SERVER_ERROR                                        = 200;
    const HTTP_NOT_IMPLEMENTED                                              = 200;
    const HTTP_BAD_GATEWAY                                                  = 200;
    const HTTP_SERVICE_UNAVAILABLE                                          = 200;
    const HTTP_GATEWAY_TIMEOUT                                              = 200;
    const HTTP_VERSION_NOT_SUPPORTED                                        = 200;
    const HTTP_VARIANT_ALSO_NEGOTIATES_EXPERIMENTAL                         = 200;
    const HTTP_INSUFFICIENT_STORAGE                                         = 200;
    const HTTP_LOOP_DETECTED                                                = 200;
    const HTTP_NOT_EXTENDED                                                 = 200;
    const HTTP_NETWORK_AUTHENTICATION_REQUIRED                              = 200;
    Testes forçados para o Android (Volley)*/
